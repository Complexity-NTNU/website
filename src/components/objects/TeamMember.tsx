...
const TeamMember: React.FC<MemberProps> = ({
	...
	return (
		<div className="relative text-center">
			<div className="flex flex-col content-start w-fit">
				<div className="group relative rounded-xl overflow-hidden mx-auto w-80 h-96">
					{image ? (
						<Image
							src={image}
							alt={name}
						...
						<Image
							src="/profile_picture_placeholder.png"
							alt={name}
							width={400}
							height={300}
							className="object-cover w-full h-full"

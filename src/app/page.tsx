		...
		<div>
			<div>
				...
				<main className="bg-[#D9D9D9]">
					<div className="bg-[#F1F1F1] rounded-b-[50px]">
					...
					<div>
						<div className="max-w-4xl mx-auto py-16 md:py-52 px-3 flex flex-col">
							...
							<p className="text-[#7C7C7C] pt-10  md:text-lg px-4">
							...
							<p className="text-[#7C7C7C] pt-4  md:text-lg px-4">
								We're seeking talented and driven students in computer science,
								engineering, physics, and related fields to pioneer innovations
								in artificial intelligence. Students passionate about marketing,
					...
					<div className="bg-white rounded-t-[50px] mb-10 md:mb-40">
							...
							<div className="flex flex-col gap-4 p-4 px-4 md:px-8">
								<div>
									...
									<p className="pb-6 ">
										...
										students from technical, business, and creative backgrounds
										to work together on one major AI initiative throughout the
										year. Join us to collaborate, innovate, and create something
										noteworthy!
									</p>
									<a href="/applications">
